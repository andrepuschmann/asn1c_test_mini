...
static int
memb_ue_CategoryDL_v13xy_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long long value;
...
static asn_per_constraints_t asn_PER_memb_ue_CategoryDL_v13xy_constr_2 GCC_NOTUSED = {
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_6 = {
	sizeof(struct UE_EUTRA_Capability_v1330_IEs__nonCriticalExtension),
	offsetof(struct UE_EUTRA_Capability_v1330_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v1330_IEs_1[] = {
	{ ATF_POINTER, 4, offsetof(struct UE_EUTRA_Capability_v1330_IEs, ue_CategoryDL_v13xy),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_ue_CategoryDL_v13xy_constraint_1,
		&asn_PER_memb_ue_CategoryDL_v13xy_constr_2,
		0,
		"ue-CategoryDL-v13xy"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_v1330_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-CategoryDL-v13xy */
