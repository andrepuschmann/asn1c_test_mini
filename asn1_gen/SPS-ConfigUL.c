...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SPS_ConfigUL__setup, p0_Persistent),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SPS_ConfigUL__setup, twoIntervalsConfig),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SPS_ConfigUL__setup, p0_PersistentSubframeSet2_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct SPS_ConfigUL__setup, numberOfConfUlSPS_Processes_r13),
...
static const int asn_MAP_setup_oms_3[] = { 2, 3, 4, 5 };
