...
static const ber_tlv_tag_t asn_DEF_nonCriticalExtension_tags_29[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_29 = {
	sizeof(struct SystemInformationBlockType1_v1320_IEs__nonCriticalExtension),
	offsetof(struct SystemInformationBlockType1_v1320_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nonCriticalExtension_29 = {
	...
	SEQUENCE_encode_aper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_nonCriticalExtension_tags_29,
	sizeof(asn_DEF_nonCriticalExtension_tags_29)
		/sizeof(asn_DEF_nonCriticalExtension_tags_29[0]) - 1, /* 1 */
	asn_DEF_nonCriticalExtension_tags_29,	/* Same as above */
	sizeof(asn_DEF_nonCriticalExtension_tags_29)
		/sizeof(asn_DEF_nonCriticalExtension_tags_29[0]), /* 2 */
	0,	/* No PER visible constraints */
	0, 0,	/* No members */
	&asn_SPC_nonCriticalExtension_specs_29	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_SystemInformationBlockType1_v1320_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType1_v1320_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_nonCriticalExtension_29,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"nonCriticalExtension"
