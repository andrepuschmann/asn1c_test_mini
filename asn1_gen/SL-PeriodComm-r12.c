...
asn_dec_rval_t
SL_PeriodComm_r12_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	SL_PeriodComm_r12_1_inherit_TYPE_descriptor(td);
...
asn_enc_rval_t
SL_PeriodComm_r12_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	SL_PeriodComm_r12_1_inherit_TYPE_descriptor(td);
...
static const asn_INTEGER_specifics_t asn_SPC_SL_PeriodComm_r12_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SL_PeriodComm_r12 = {
	...
	SL_PeriodComm_r12_decode_aper,
	SL_PeriodComm_r12_encode_aper,
