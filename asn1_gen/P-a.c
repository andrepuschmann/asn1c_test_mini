...
asn_dec_rval_t
P_a_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	P_a_1_inherit_TYPE_descriptor(td);
...
asn_enc_rval_t
P_a_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	P_a_1_inherit_TYPE_descriptor(td);
...
static const asn_INTEGER_specifics_t asn_SPC_P_a_specs_1 = {
