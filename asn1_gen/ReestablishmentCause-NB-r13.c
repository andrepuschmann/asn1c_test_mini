...
asn_dec_rval_t
ReestablishmentCause_NB_r13_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ReestablishmentCause_NB_r13_1_inherit_TYPE_descriptor(td);
...
asn_enc_rval_t
ReestablishmentCause_NB_r13_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ReestablishmentCause_NB_r13_1_inherit_TYPE_descriptor(td);
...
static const asn_INTEGER_specifics_t asn_SPC_ReestablishmentCause_NB_r13_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ReestablishmentCause_NB_r13 = {
	...
	ReestablishmentCause_NB_r13_decode_aper,
	ReestablishmentCause_NB_r13_encode_aper,
