...
BandParametersDL_r13_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	...
	td->aper_decoder   = asn_DEF_CA_MIMO_ParametersDL_r13.aper_decoder;
	td->aper_encoder   = asn_DEF_CA_MIMO_ParametersDL_r13.aper_encoder;
...
asn_dec_rval_t
BandParametersDL_r13_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	BandParametersDL_r13_1_inherit_TYPE_descriptor(td);
...
asn_enc_rval_t
BandParametersDL_r13_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	BandParametersDL_r13_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_BandParametersDL_r13 = {
	...
	BandParametersDL_r13_decode_aper,
	BandParametersDL_r13_encode_aper,
